...
public class SearchOnTraineesUsersPage extends PageBase {

	public SearchOnTraineesUsersPage(WebDriver driver) {
		super(driver);
	}
	...
	public void OpenSearchonTraineePageinActiveTab(String Text) throws InterruptedException
	{
