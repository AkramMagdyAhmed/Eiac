...
public class SortByInAllAssessmentExpReq extends TestBase{
	...
	@Test(priority = 2)
	public void SortBySuccessfully() throws InterruptedException
	{
		AllAssessmentExperienceRequestsPageObj = new AllAssessmentExperienceRequestsPage(driver);
		AllAssessmentExperienceRequestsPageObj.SortByRequestedOn();
	}
