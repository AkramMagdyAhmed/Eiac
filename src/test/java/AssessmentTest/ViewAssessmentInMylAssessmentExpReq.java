...
public class ViewAssessmentInMylAssessmentExpReq extends TestBase {
	...
	public void ViewAssessmentSuccessfully() throws InterruptedException
	{
		...
		AssessmentExperienceRequestsPageObj.ViewAssessment();
		Assert.assertTrue(AssessmentExperienceRequestsPageObj.HeaderText.isDisplayed());
		driver.quit();
	}
