...
public class AsAccreditationManagerCanPermanentlyDeclineAssessment extends TestBase {
	...
	// Acc Man perform Permanently Decline
	@Test(priority = 2)
	public void PermanentlyDeclineAssessment() throws InterruptedException {
		...
		AllAssessmentExperienceRequestsPageObj.PermanentlyDeclineAssessmentFromAccManagerUser();
	}
